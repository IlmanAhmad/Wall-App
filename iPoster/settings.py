"""
Django settings for iPoster project.
...
SECRET_KEY = 'dj^vg-7jrh^$w8$vgvwd((fqyi40ofmu)z+i^7lw3yrh(zl38)'
...
WSGI_APPLICATION = 'iPoster.wsgi.application'
...
# Custom user model
AUTH_USER_MODEL = 'postapiapp.USERPROFILE'
